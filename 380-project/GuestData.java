...
public class GuestData {
    ...
    // // Constructor to initialize connection using SqlConnector
    // public GuestData() throws SQLException {
    //     this.connection = SqlConnector.getConnection();  // Retrieve the connection
